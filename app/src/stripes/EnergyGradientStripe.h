...
class EnergyGradientStripe: public BaseStripe{
public:
	EnergyGradientStripe(){
		colour.r = 255;
		colour.g = 0;
		colour.b = 0;
	...
	virtual ~EnergyGradientStripe(){} //destructor
	
	EnergyGradientStripe(float _x, float _y, float _w, float _h, ofColor c1, ofColor c2, ofColor c3, float midPosition, float vel){
		x = _x;
		y = _y;
		width = _w;
		height = _h;
...
//		//Set
//	EnergyGradientStripe & operator=( const BasicStripe& stripe ){
//		x = stripe.x;
//		y = stripe.y;
//		width = stripe.width;
...
//	
//		//Set
//	EnergyGradientStripe & operator=( const EnergyGradientStripe& stripe ){
//		x = stripe.x;
//		y = stripe.y;
//		width = stripe.width;
//		height = stripe.height;
