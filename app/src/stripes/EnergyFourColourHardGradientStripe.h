/*
 *  EnergyFourColourHardGradientStripe.h
 *  uniqloHAndL
 *
...
class EnergyFourColourHardGradientStripe: public BaseStripe{
public:
	EnergyFourColourHardGradientStripe(){
		colour.r = 255;
		colour.g = 0;
		colour.b = 0;
	...
	virtual ~EnergyFourColourHardGradientStripe(){} //destructor
	
	EnergyFourColourHardGradientStripe(float _x, float _y, float _w, float _h, ofColor c1, ofColor c2, ofColor c3, ofColor c4, float midPosition, float vel){
		x = _x;
		y = _y;
		width = _w;
		height = _h;
